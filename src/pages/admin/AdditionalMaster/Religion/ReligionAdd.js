                            ...
                            <div className="row py-4">
                                <div className="col-md-6 col-12 mb-2">
                                    ...
                                    <div className="input-group mb-3">
                                        <input
                                            type="text"
                                            className={`form-control   ${formik.touched.religionCode && formik.errors.religionCode
                                                ? "is-invalid"
                                                : ""
                                                }`}
                                        ...
                                        />
                                        {formik.touched.religionCode && formik.errors.religionCode && (
                                ...
                                <div className="col-md-6 col-12 mb-2">
                                    ...
                                    <div className="input-group mb-3">
                                        <input
                                            type="text"
                                            className={`form-control   ${formik.touched.religionName && formik.errors.religionName
                                                ? "is-invalid"
                                                : ""
                                                }`}
                                        ...
                                        />
                                        {formik.touched.religionName && formik.errors.religionName && (
                                            <div className="invalid-feedback">
