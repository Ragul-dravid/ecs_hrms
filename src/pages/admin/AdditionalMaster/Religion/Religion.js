...
import ReligionEdit from "./ReligionEdit";

const Religion = ({ handleCenterChanged }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: "religionCode",
        enableHiding: false,
        header: "RELIGION CODE",
      },
      {
  ...
  const getData = async () => {
    try {
      const response = await api.get(`ecs-religion`);
