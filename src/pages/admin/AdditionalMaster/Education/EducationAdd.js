...
function NationalityAdd({ onSuccess }) {
    ...
    const validationSchema = yup.object().shape({
        ...
        irbanationalityCode: yup.string().required("*IRBA Nationality Name is required"),
    });
                            ...
                            <div className="row py-4">
                                <div className="col-md-6 col-12 mb-2">
                                    ...
                                    <div className="input-group mb-3">
                                        <input
                                            type="text"
                                            className={`form-control   ${formik.touched.nationalityCode && formik.errors.nationalityCode
                                                ? "is-invalid"
                                                : ""
                                                }`}
                                        ...
                                        />
                                        {formik.touched.nationalityCode && formik.errors.nationalityCode && (
                                ...
                                <div className="col-md-6 col-12 mb-2">
                                    ...
                                    <div className="input-group mb-3">
                                        <input
                                            type="text"
                                            className={`form-control   ${formik.touched.nationalityName && formik.errors.nationalityName
                                                ? "is-invalid"
                                                : ""
                                                }`}
                                ...
                                <div className="col-md-6 col-12 mb-2">
                                    ...
                                    <div className="input-group mb-3">
                                        <select
                                            ...
                                            className={`form-select form-select-sm  ${formik.touched.irbanationalityCode && formik.errors.irbanationalityCode
                                                ? "is-invalid"
                                                : ""
                                                }`}
                                        >
                                        ...
                                        {formik.touched.irbanationalityCode && formik.errors.irbanationalityCode && (
                                            <div className="invalid-feedback">
