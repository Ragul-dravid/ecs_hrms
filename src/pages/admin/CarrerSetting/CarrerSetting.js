...
import CarrerSettingAdd from "./CarrerSettingAdd";
import CarrerSettingEdit from "./CarrerSettingEdit";

const CarrerSetting = ({ handleCenterChanged }) => {
