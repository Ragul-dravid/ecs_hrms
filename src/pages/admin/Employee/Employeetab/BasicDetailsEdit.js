                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <input
                                                                {...formik.getFieldProps(
                                                                    `childrenDetails[${index}].dob`
                                                                )}
                                                                className={`form-control ${formik.touched.childrenDetails?.[index]
                                                                    ?.dob &&
                                                                    formik.errors.childrenDetails?.[index]
                                                                        ?.dob
                                                                    ? "is-invalid"
                                                                    : ""
                                                                    }`}
                                                                ...
                                                                readOnly
                                                            />
                                                            {formik.touched.childrenDetails?.[index]
                                                                ?.dob &&
                                                                formik.errors.childrenDetails?.[index]
                                                                    ?.dob && (
                                                                    <div className="invalid-feedback">
                                                        ...
                                                        <td>
                                                            <select
                                                                className={`form-select ${formik.touched.childrenDetails?.[index]
                                                                    ?.gender &&
                                                        ...
                                                        <td>
                                                            <input
                                                                {...formik.getFieldProps(
                                                                    `childrenDetails[${index}].certNumber`
                                                                )}
                                                        ...
                                                        <td>
                                                            <select
                                                                ...
                                                                {...formik.getFieldProps(
                                                                    `childrenDetails[${index}].citizenship`
                                                                )}
                                                                style={{ width: "100%" }}
                                                            >
                                                                <option selected></option>
