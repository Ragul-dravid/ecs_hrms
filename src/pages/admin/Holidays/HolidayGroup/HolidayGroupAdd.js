...
function HolidayGroupAdd({ onSuccess }) {
  ...
  const validationSchema = yup.object().shape({
    holidayGroupCode: yup.string().required("*Holiday Group Code is required"),
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await api.post("/createEcsHolidayGroup", values, {
          headers: {
      ...
      >
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title className="headColor">Add Holiday Group</Modal.Title>
          </Modal.Header>
          <Modal.Body>
              ...
              <div className="row py-4">
                <div className="col-md-6 col-12 mb-2">
                  <label className="form-label">
                    Holiday Group Code<span className="text-danger">*</span>
                  </label>
...
export default HolidayGroupAdd;
