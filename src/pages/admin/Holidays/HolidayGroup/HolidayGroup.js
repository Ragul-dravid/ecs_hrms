...
import HolidayGroupAdd from "./HolidayGroupAdd";
import HolidayGroupEdit from "./HolidayGroupEdit";

const HolidayGroup = ({ handleCenterChanged }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: "holidayGroupCode",
        enableHiding: false,
        header: "HOLIDAY GROUP CODE",
      },
      {
        accessorKey: "holidayGroupName",
        enableHiding: false,
        header: "HOLIDAY GROUP NAME",
      },
