...
function BasicCategoryAdd({ onSuccess }) {
  ...
  const validationSchema = yup.object().shape({
    categoryCode: yup.string().required("*Subject is required"),
    categoryName: yup.string().required("*Code is required"),
  });
      ...
      >
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title className="headColor">Add Category</Modal.Title>
          </Modal.Header>
          <Modal.Body>
...
export default BasicCategoryAdd;
