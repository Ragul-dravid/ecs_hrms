...
import PayableDeductibleAdd from "./PayableDeductibleAdd";
import PayableDeductibleEdit from "./PayableDeductibleEdit";

const PayableDeductible = () => {
...
export default PayableDeductible;
